...
def seed():
    ...
    with open('general_locations.csv', 'r') as csvfile:
        ...
        for row in genlocreader:
            genlocs = models.GeneralLocation(id=row['id'], name=row['name'],
    ...
    with open('location_codes.csv', 'r') as csvfile:
        ...
        for row in loccodereader:
            loccode = models.SpecificLocation(id=row['id'], name=row['name'],
                                              general_location_id=row[
                                              'general_location_id'])
    ...
    with open('incident_types.csv', 'r') as csvfile:
        ...
        for row in typereader:
            typecode = models.Type(id=row['id'], code=row['code'],
